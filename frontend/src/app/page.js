...
const tools = [
  { name: 'PDF Compressor', description: 'Reduce PDF file size while maintaining quality.', href: '/pdf-compressor', icon: '📄', iconBg: 'rgba(239,68,68,0.08)' },
  { name: 'Split PDF', description: 'Extract specific pages from a PDF. Keep only what you need.', href: '/split-pdf', icon: '✂️', iconBg: 'rgba(245,158,11,0.08)' },
  { name: 'PDF Merger', description: 'Combine multiple PDFs into a single document.', href: '/pdf-merger', icon: '📑', iconBg: 'rgba(59,130,246,0.08)' },
  { name: 'PDF to JPG', description: 'Convert PDF pages into high-quality JPG images.', href: '/pdf-to-jpg', icon: '🖼️', iconBg: 'rgba(245,158,11,0.08)' },
  { name: 'JPG to PDF', description: 'Convert JPG & PNG images into a multi-page PDF.', href: '/jpg-to-pdf', icon: '📸', iconBg: 'rgba(34,197,94,0.08)' },
  { name: 'PDF to Word', description: 'Convert PDF to editable DOCX documents.', href: '/pdf-to-word', icon: '📝', iconBg: 'rgba(59,130,246,0.08)' },
  { name: 'Word to PDF', description: 'Convert DOCX files to professional PDF format.', href: '/word-to-pdf', icon: '📋', iconBg: 'rgba(99,102,241,0.08)' },
  { name: 'Rotate PDF', description: 'Rotate all pages by 90°, 180°, or 270°.', href: '/rotate-pdf', icon: '🔄', iconBg: 'rgba(59,130,246,0.08)' },
  { name: 'Watermark PDF', description: 'Add text watermark to every page. Customizable opacity & size.', href: '/watermark-pdf', icon: '💧', iconBg: 'rgba(139,92,246,0.08)' },
  { name: 'PDF Password', description: 'Encrypt PDFs with AES password protection.', href: '/pdf-password', icon: '🔒', iconBg: 'rgba(99,102,241,0.08)' },
  { name: 'Unlock PDF', description: 'Remove password protection from encrypted PDFs.', href: '/unlock-pdf', icon: '🔓', iconBg: 'rgba(245,158,11,0.08)' },
  { name: 'Page Numbers', description: 'Add page numbers to every page. Choose position & format.', href: '/page-numbers', icon: '🔢', iconBg: 'rgba(59,130,246,0.08)' },
  { name: 'Organize PDF', description: 'Reorder, duplicate, or remove pages from your PDF.', href: '/organize-pdf', icon: '📋', iconBg: 'rgba(139,92,246,0.08)' },
  { name: 'Text to PDF', description: 'Convert text & notes into a formatted PDF document.', href: '/html-to-pdf', icon: '📝', iconBg: 'rgba(236,72,153,0.08)' },
  { name: 'JPG Compressor', description: 'Compress images with adjustable quality. MozJPEG optimized.', href: '/jpg-compressor', icon: '🗜️', iconBg: 'rgba(34,197,94,0.08)' },
  { name: 'Image Resizer', description: 'Resize to exact dimensions or target file size.', href: '/image-resizer', icon: '📐', iconBg: 'rgba(59,130,246,0.08)' },
  { name: 'Image Converter', description: 'Convert between JPG, PNG, WebP, AVIF, TIFF, GIF.', href: '/image-converter', icon: '🔄', iconBg: 'rgba(139,92,246,0.08)' },
  { name: 'Metadata Stripper', description: 'Remove hidden EXIF, GPS, camera info from photos.', href: '/metadata-stripper', icon: '🛡️', iconBg: 'rgba(239,68,68,0.08)' },
  { name: 'Video to Audio', description: 'Extract audio from MP4, MKV, AVI, MOV & more.', href: '/video-to-audio', icon: '🎬', iconBg: 'rgba(236,72,153,0.08)' },
  { name: 'Audio Converter', description: 'Convert MP3, WAV, AAC, OGG, FLAC, OPUS & more.', href: '/audio-converter', icon: '🎵', iconBg: 'rgba(245,158,11,0.08)' },
];
        ...
        <div className="tools-grid" style={{ marginTop: 28 }}>
          {tools.map((tool) => (
            <Link key={tool.href} href={tool.href} className="tool-card">
              <div className="tool-card-icon" style={{ background: tool.iconBg }}>{tool.icon}</div>
              <h3>{tool.name}</h3>

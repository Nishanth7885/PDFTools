...
const tools = [
  ...
  { name: 'PDF to Excel', description: 'Extract tables & text from PDF into editable Excel sheets.', href: '/pdf-to-excel', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><path d="M8 13h2M8 17h2M14 13h2M14 17h2" /><path d="M8 15h8" /></svg>, iconBg: 'rgba(34,197,94,0.08)' },
  { name: 'PDF to PPT', description: 'Convert PDF presentations into high-quality PowerPoint.', href: '/pdf-to-ppt', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><rect x="8" y="13" width="8" height="6" /><path d="M10 13v6M8 15h8" /></svg>, iconBg: 'rgba(245,158,11,0.08)' },
  ...
  { name: 'HEIC to JPG Batch', description: 'Convert multiple HEIC images to JPG format instantly.', href: '/heic-to-jpg-batch', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2" /><circle cx="9" cy="9" r="2" /><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" /></svg>, iconBg: 'rgba(16,185,129,0.08)' },
  { name: 'Print-Ready PDF', description: 'Prepare for print: CMYK, 300 DPI, & Bleed Margins.', href: '/print-ready-pdf', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 6 2 18 2 18 9" /><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" /><rect width="12" height="8" x="6" y="14" /></svg>, iconBg: 'rgba(56,189,248,0.08)' }
];
